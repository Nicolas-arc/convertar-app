...
(function(){
  ...
  if(!document.getElementById('ph-wp-style')){
    ...
    st.textContent='#ph-wp-btn{display:inline-flex;align-items:center;gap:9px;'
    +'padding:11px 20px;border:2px solid #25d366;border-radius:8px;'
    +'background:#fff;color:#128c4e;font-size:14px;font-weight:700;'
    +'text-decoration:none;cursor:pointer;margin:10px 0;'
    +'font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;'
    +'transition:background .2s,color .2s;}'
    +'#ph-wp-btn:hover{background:#25d366;color:#fff;}'
    +'#ph-wp-btn svg{flex-shrink:0;}';
